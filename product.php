...
include_once 'resources/comment_add.php';
...
<html>
    <head>
        ...
        <link href="custom/css/product.min.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
            ...
            <div id="main">
                <div id="product">
                    <div id="product-container">
                        <?php 
                            include_once 'resources/product_detail.php';
                            include_once 'resources/show_comments.php';
                        ?> 
                    </div>
                </div>
                <div id="new">
        ...
        <script src="custom/js/char_counter.min.js" nonce="<?php echo $nonce;?>"></script>
    </body>
</html>
